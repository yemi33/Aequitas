import { DELETE_AEQUITAS_RESULT_FAIL, DELETE_AEQUITAS_RESULT_REQUEST, DELETE_AEQUITAS_RESULT_RESET, DELETE_AEQUITAS_RESULT_SUCCESS, GET_AEQUITAS_RESULT_FAIL, GET_AEQUITAS_RESULT_PENDING, GET_AEQUITAS_RESULT_REQUEST, GET_AEQUITAS_RESULT_SUCCESS, GET_IMPROVEMENT_GRAPH_FAIL, GET_IMPROVEMENT_GRAPH_REQUEST, GET_IMPROVEMENT_GRAPH_SUCCESS, RUN_AEQUITAS_FAIL, RUN_AEQUITAS_REQUEST, RUN_AEQUITAS_RESET, RUN_AEQUITAS_SUCCESS } from "../constants/aequitasConstants";
...
export const getAequitasResultReducer = (state = {}, action) => {
  switch (action.type) {
    case GET_AEQUITAS_RESULT_REQUEST:
      return { loading: true };
    case GET_AEQUITAS_RESULT_PENDING:
      return { loading: true, status: 'Pending' };
    case GET_AEQUITAS_RESULT_SUCCESS:
      return { loading: false, status: 'Success', aequitasRunResult: action.payload };
